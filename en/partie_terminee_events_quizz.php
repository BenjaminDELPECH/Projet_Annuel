...
$_SESSION['affiche_perdu']=FALSE;
	...
	<div class="mdl-cell mdl-cell--7-col" id="record_cadre" style="margin-left:100px;position:absolute;box-shadow:2px 2px 12px #AAAAAA;padding:10px;background-color:#DDDDDD;">
	<script>
	document.getElementById("cadre_quizz1").style.opacity = "0.2";
	
	
	function retabli(){
		document.getElementById("cadre_quizz1").style.opacity = "1";
	...
	<?php $query=$bdd->query("Select * from topscore where nomjeux like 'quizz' limit 0,3 ");
