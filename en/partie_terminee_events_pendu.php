...
$_SESSION['affiche_perdu']=FALSE;
	...
	<script>
	document.getElementById("cadre_pendu1").style.opacity = "0.2";
	document.getElementById("cadre_pendu2").style.opacity = "0.2";
	document.getElementById("cadre_pendu3").style.opacity = "0.2";
	document.getElementById("cadre_pendu4").style.opacity = "0.2";
	
	
	
	function retabli(){
			document.getElementById("cadre_pendu1").style.opacity = "1";
	document.getElementById("cadre_pendu2").style.opacity = "1";
	document.getElementById("cadre_pendu3").style.opacity = "1";
	document.getElementById("cadre_pendu4").style.opacity = "1";
	...
	<div class="mdl-grid mdl-cell--12-col"  id="div_topscore" STYLE="margin-top:14px;font-size:22px;"><b>High Scores</b>
	...
	<?php $query=$bdd->query("Select * from topscore where nomjeux like 'pendu' limit 0,3 ");
