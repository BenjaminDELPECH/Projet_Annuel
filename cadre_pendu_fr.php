...
?> <div class="mdl-grid mdl-cell--10-col" style="margin-top:50px;" >
...
?></div>
 ...
 <div  > <div style="font-size:27px;">Lettres déjà choisies:</div>
 <div style="margin-top:45px;font-size:30px;">
...
<div class="mdl-grid mdl-cell--8-col center" style="margin-top:60px;">
